...
public class BookController {
	...
	@GetMapping("getOrderInculdeBooks/{orderId}")
	public @ResponseBody List<OrderInculdeBooks> findOrderBooks(@PathVariable("orderId")String orderId){
		return bs.getOrderInculdeBooks(orderId);
	}
}
