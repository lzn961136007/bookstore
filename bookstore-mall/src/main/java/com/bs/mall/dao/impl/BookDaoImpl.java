...
public class BookDaoImpl implements BookDao {
	...
	@Override
	public BookTheme referBookTheme(Integer themeId) {
		return bm.selectBookTheme(themeId);
	}
	@Override
	public List<OrderInculdeBooks> referOrderInculdeBooks(String orderId) {
		return bm.selectOrderInculdeBooks(orderId);
	}
