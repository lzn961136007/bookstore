...
public class SendEmail {
    ...
    public static MimeMessage getMimeMessage(Session session,String recipientAddress) throws Exception{
        ...
        String email="<h1><a href='"+BookStoreConstant.APPSERVERADDRESS+"/bookstore-mall/"+recipientAddress+"/active/updateStatus'>"+BookStoreConstant.APPSERVERADDRESS+"/bookstore-mall/"+recipientAddress+"/active/updateStatus</a>激活账户<h1>";       
